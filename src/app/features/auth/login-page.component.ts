        ...
        <section class="flex items-center justify-center px-8 py-12">
          <div class="w-full max-w-md">
            <div class="mb-10">
              ...
              <h1 class="text-3xl font-bold text-ortho-navy tracking-tight">Sign in to OrthoFlow</h1>
              <p class="mt-2 text-ortho-navy/50">Enter your credentials to access your practice.</p>
            </div>

            <form class="space-y-6">
              <div class="space-y-2">
                <label class="text-sm font-semibold text-ortho-navy/70" for="email">Email address</label>
                <input 
                  id="email" 
                  type="email" 
              ...
              <div class="space-y-2">
                <div class="flex items-center justify-between">
                  <label class="text-sm font-semibold text-ortho-navy/70" for="password">Password</label>
                  <a href="#" class="text-xs font-bold text-ortho-teal hover:underline">Forgot password?</a>
                </div>
                <input 
                  id="password" 
                  type="password" 
              ...
              <div class="flex items-center gap-3">
                ...
                />
                <label for="remember" class="text-sm font-medium text-ortho-navy/60">Keep me signed in</label>
              </div>
            ...
            <div class="mt-8 text-center">
              <p class="text-sm text-ortho-navy/50">
                ...
                <a routerLink="/" class="font-bold text-ortho-teal hover:underline">Request a demo</a>
              </p>
            </div>
          </div>
        </section>
        ...
        <aside class="hidden bg-ortho-navy lg:flex items-center justify-center p-12">
          <div class="relative w-full max-w-lg">
            ...
            <div class="tile p-8 relative z-10 overflow-hidden bg-white/5 border-white/10 backdrop-blur-sm">
              <h2 class="text-3xl font-bold text-white tracking-tight">The most reliable platform for your practice.</h2>
              <p class="mt-4 text-white/60 leading-relaxed text-lg">
                Join thousands of orthodontists who have simplified their workflow with OrthoFlow.
              </p>
