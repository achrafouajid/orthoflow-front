    ...
    >
      ...
      <div class="flex h-16 items-center px-6 border-b border-ortho-navy/5 overflow-hidden">
        <div class="flex items-center gap-3 shrink-0">
          <div class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-ortho-navy text-white font-bold">O</div>
          <span 
            class="text-lg font-bold tracking-tight text-ortho-navy transition-all duration-300"
